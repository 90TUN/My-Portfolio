        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p className="text-lg">
                  ...
                  and <span className="font-semibold text-black">Data Science Enthusiast</span>. 
          ...
          <div className="lg:sticky lg:top-32">
            <div className="bg-gray-50 p-8 border border-gray-200">
              <h3 className="text-xl font-semibold text-black mb-8 text-center">
                By the Numbers
              </h3>
              <div className="grid grid-cols-2 gap-6">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center group">
                    <div className="bg-white p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
