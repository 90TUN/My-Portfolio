...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center py-20 pt-32 px-4 bg-white relative overflow-hidden">
      {/* Animated Background Patterns */}
      <div className="absolute inset-0 z-0">
        {/* Floating Geometric Shapes */}
        <div className="absolute top-20 left-10 w-2 h-2 bg-black opacity-20 animate-pulse"></div>
        <div className="absolute top-32 right-16 w-1 h-1 bg-gray-400 animate-bounce" style={{ animationDelay: '0.5s' }}></div>
        <div className="absolute top-64 left-1/4 w-1.5 h-1.5 bg-black opacity-30 animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-40 right-1/3 w-2 h-2 bg-gray-300 animate-bounce" style={{ animationDelay: '1.5s' }}></div>
        <div className="absolute top-48 right-20 w-1 h-1 bg-black opacity-40 animate-pulse" style={{ animationDelay: '2s' }}></div>
        
        {/* Additional Floating Elements */}
        <div className="absolute top-16 left-1/3 w-3 h-3 bg-gray-200 opacity-25 animate-bounce" style={{ animationDelay: '2.8s' }}></div>
        <div className="absolute top-72 left-16 w-1.5 h-1.5 bg-black opacity-35 animate-pulse" style={{ animationDelay: '3.2s' }}></div>
        <div className="absolute bottom-64 left-1/2 w-2 h-2 bg-gray-400 opacity-30 animate-bounce" style={{ animationDelay: '1.8s' }}></div>
        <div className="absolute top-40 left-3/4 w-1 h-1 bg-black opacity-45 animate-pulse" style={{ animationDelay: '2.4s' }}></div>
        <div className="absolute bottom-20 right-16 w-2.5 h-2.5 bg-gray-300 opacity-20 animate-bounce" style={{ animationDelay: '3.6s' }}></div>
        <div className="absolute top-80 right-1/4 w-1 h-1 bg-black opacity-50 animate-pulse" style={{ animationDelay: '0.8s' }}></div>
        <div className="absolute bottom-80 left-20 w-1.5 h-1.5 bg-gray-400 opacity-35 animate-bounce" style={{ animationDelay: '4s' }}></div>
        <div className="absolute top-56 right-32 w-2 h-2 bg-black opacity-25 animate-pulse" style={{ animationDelay: '1.2s' }}></div>
        <div className="absolute bottom-48 right-12 w-1 h-1 bg-gray-300 opacity-40 animate-bounce" style={{ animationDelay: '2.6s' }}></div>
        
        {/* Hexagonal Tech Elements */}
        <div className="absolute top-28 left-2/3 w-4 h-4 border border-gray-300 opacity-30 rotate-45 animate-pulse" style={{ animationDelay: '1.4s' }}></div>
        <div className="absolute bottom-32 left-1/3 w-3 h-3 border border-black opacity-20 rotate-12 animate-pulse" style={{ animationDelay: '3.8s' }}></div>
        <div className="absolute top-44 right-28 w-2 h-2 border border-gray-400 opacity-35 -rotate-45 animate-pulse" style={{ animationDelay: '2.2s' }}></div>
        ...
        <div className="absolute top-24 right-32 opacity-30">
        ...
        <div className="absolute bottom-32 left-24 opacity-25">
          <div className="text-xs font-mono text-gray-400 animate-pulse" style={{ animationDelay: '3.2s' }}>
            {'{...}'}
          </div>
        </div>
        ...
        <div className="absolute bottom-24 right-20 opacity-25">
        ...
        <div className="absolute top-40 left-2/3 opacity-20">
        ...
        <div className="absolute top-52 right-1/4 opacity-30">
        ...
        <div className="absolute top-36 right-1/3 opacity-35">
        ...
        {/* Binary Code Streams */}
        <div className="absolute top-20 left-1/2 opacity-15">
          <div className="text-xs font-mono text-gray-400 animate-pulse" style={{ animationDelay: '4.3s' }}>
            {'101010'}
          </div>
        </div>
        
        <div className="absolute top-60 left-16 opacity-25">
      ...
      <div className="text-center max-w-3xl mx-auto relative z-10">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight text-black mb-6 tracking-tight">
          Hello, I'm Ayomidotun
        </h1>
        
        {/* Subtitle */}
        <p className="text-xl sm:text-2xl md:text-3xl text-gray-600 mb-12 font-normal leading-snug">
